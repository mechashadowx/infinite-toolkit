export default function PrivacyPolicy() {
    return (
        <div className="m-16 flex flex-col items-center gap-4">
            ...
            <ul>
                ...
                <li>
                    <p>
                        ...
                        &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                        or &quot;Our&quot; in this Agreement) refers to Infinite
                        Toolkit.
                    </p>
                </li>
                <li>
                ...
                <li>
                    <p>
                        <strong>Country</strong> refers to: Jordan
                    </p>
                </li>
                <li>
                    <p>
                ...
                <li>
                    <p>
                        <strong>Website</strong> refers to Infinite Toolkit,
                        accessible from{" "}
                        <a
                            href="https://mechashadowx.github.io/Portfolio/"
                            rel="external nofollow noopener"
                            target="_blank"
                        >
                            https://mechashadowx.github.io/Portfolio/
                        </a>
                    </p>
                </li>
                <li>
            ...
            <ul>
                <li>By email: infinite.toolkit.2024@gmail.com</li>
            </ul>
        </div>
    );
}
